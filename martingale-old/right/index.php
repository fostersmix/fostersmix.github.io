...
//set parameters
        ...
        $rootURL = "http://thestartman.ru/bet/right"; //example https://mysite.org  or http://yourhomepage.com/store
        $orderID = uniqid();
...
<a href="bitcoin:<?=$pay?>"><img src="https://blockchain.info/qr?data=<?=$pay?>&size=200" class="padding border transition round"></a>
